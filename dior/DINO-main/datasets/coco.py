...
def make_coco_transforms(image_set, fix_size=False, strong_aug=False, args=None):
    ...
    scales3 = [480, 512, 544, 576, 608, 640, 672, 704, 736, 768]
    max_size3 = 800
...
def build(image_set, args):
    ...
    image_val_path = Path(args.image_val_path)

    mode = 'instances'
    # PATHS = {
    #     "train": (root / "positive image set", root / f'{mode}_train2017.json'),
    #     "train_reg": (root / "positive image set", root / f'{mode}_train2017.json'),
    #     "val": (root / "positive image set", root / f'{mode}_val2017.json'),
    #     "eval_debug": (root / "positive image set", root / f'{mode}_val2017.json'),
    #     "test": (root / "positive image set", root / f'{mode}_val2017.json'),
    # }
    PATHS = {
        "train": (image_path, train_path),
        "train_reg": (image_path,  train_path),
        "val": (image_val_path, val_path),
        "eval_debug": (image_val_path, val_path),
        "test": (image_val_path, val_path),
    }
